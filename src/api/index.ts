...
import actionsDepositBindingsV1 from "./actions/deposit-bindings/v1";
...
import queriesDepositBindingsByNonceV1 from "./queries/deposit-bindings/by-nonce/v1";
